...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Cryptocare: 3.5 days
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "The Indian Express 20/Nov/2019 CNN seeks emergency court hearing again White House";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1542654660;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2084524493;

        if (fTestNet)
        {
            block.nTime    = 1542654636;
        ...
        assert(block.hashMerkleRoot == uint256("0xd928b0191548083ad8406e30a4285f5134bee21682319baffd13c880b02d24a8"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xe3, 0xd4, 0xa1, 0xf8 }; // Cryptocare: increase each by adding 2 to bitcoin's value.
